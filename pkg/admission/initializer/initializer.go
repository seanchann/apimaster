...
func New(
	extClientset interface{},
	dynamicClient dynamic.Interface,
	extInformers interface{},
...
func (i pluginInitializer) Initialize(plugin admission.Interface) {
	...
	if wants, ok := plugin.(WantsExternalNormalClientSet); ok {
		wants.SetExternalNormalClientSet(i.externalClient)
	}
	...
	if wants, ok := plugin.(WantsExternalNormalInformerFactory); ok {
		wants.SetExternalNormalInformerFactory(i.externalInformers)
	}
