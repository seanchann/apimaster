...
import (
	...
	validationhelpers "github.com/seanchann/apimaster/pkg/componenthelpers/auth/rbac/validation"
...
func ConfirmNoEscalation(ctx context.Context, ruleResolver AuthorizationRuleResolver, rules []rbacv1.PolicyRule) error {
	...
	ownerRightsCover, missingRights := validationhelpers.Covers(ownerRules, rules)
	if !ownerRightsCover {
