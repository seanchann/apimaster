...
import (
	...
	rbacapiv1 "github.com/seanchann/apimaster/pkg/apis/rbac/v1"
	"github.com/seanchann/apimaster/pkg/componenthelpers/auth/rbac/reconciliation"
	"github.com/seanchann/apimaster/pkg/registry/rbac/clusterrole"
	clusterrolepolicybased "github.com/seanchann/apimaster/pkg/registry/rbac/clusterrole/policybased"
	clusterrolestore "github.com/seanchann/apimaster/pkg/registry/rbac/clusterrole/storage"
	"github.com/seanchann/apimaster/pkg/registry/rbac/clusterrolebinding"
	clusterrolebindingpolicybased "github.com/seanchann/apimaster/pkg/registry/rbac/clusterrolebinding/policybased"
	clusterrolebindingstore "github.com/seanchann/apimaster/pkg/registry/rbac/clusterrolebinding/storage"
	"github.com/seanchann/apimaster/pkg/registry/rbac/role"
	rolepolicybased "github.com/seanchann/apimaster/pkg/registry/rbac/role/policybased"
	rolestore "github.com/seanchann/apimaster/pkg/registry/rbac/role/storage"
	"github.com/seanchann/apimaster/pkg/registry/rbac/rolebinding"
	rolebindingpolicybased "github.com/seanchann/apimaster/pkg/registry/rbac/rolebinding/policybased"
	rolebindingstore "github.com/seanchann/apimaster/pkg/registry/rbac/rolebinding/storage"
	rbacregistryvalidation "github.com/seanchann/apimaster/pkg/registry/rbac/validation"
	"github.com/seanchann/apimaster/plugin/pkg/auth/authorizer/rbac/bootstrappolicy"
...
func (p RESTStorageProvider) NewRESTStorage(apiResourceConfigSource serverstorage.APIResourceConfigSource, restOptionsGetter generic.RESTOptionsGetter) (genericapiserver.APIGroupInfo, error) {
	...
	// If you add a version here, be sure to add an entry in  xxx with specific priorities.
	...
	for namespace, roles := range p.Roles {
		for _, role := range roles {
			opts := reconciliation.ReconcileRoleOptions{
				...
				Client:  reconciliation.RoleModifier{Client: client.RbacV1(), NamespaceClient: client.CoreresV1().Namespaces()},
				Confirm: true,
			}
			// ServiceUnavailble error is returned when the API server is blocked by storage version updates
			err := retryOnConflictOrServiceUnavailable(retry.DefaultBackoff, func() error {
	...
	for namespace, roleBindings := range p.RoleBindings {
		for _, roleBinding := range roleBindings {
			opts := reconciliation.ReconcileRoleBindingOptions{
				...
				Client:      reconciliation.RoleBindingClientAdapter{Client: client.RbacV1(), NamespaceClient: client.CoreresV1().Namespaces()},
				Confirm:     true,
			}
			// ServiceUnavailble error is returned when the API server is blocked by storage version updates
			err := retryOnConflictOrServiceUnavailable(retry.DefaultBackoff, func() error {
